...
@javax.annotation.Generated(
    ...
    comments = "Source: BlockMultService.proto")
public final class BlockMultServiceGrpc {

  private BlockMultServiceGrpc() {}

  public static final String SERVICE_NAME = "com.client.grpc.BlockMultService";

  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.client.grpc.MatrixRequest,
      com.client.grpc.MatrixResponse> METHOD_ADD_BLOCK =
      io.grpc.MethodDescriptor.<com.client.grpc.MatrixRequest, com.client.grpc.MatrixResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.client.grpc.BlockMultService", "AddBlock"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.client.grpc.MatrixRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.client.grpc.MatrixResponse.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.client.grpc.MatrixRequest,
      com.client.grpc.MatrixResponse> METHOD_MULTIPLY_BLOCK =
      io.grpc.MethodDescriptor.<com.client.grpc.MatrixRequest, com.client.grpc.MatrixResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.client.grpc.BlockMultService", "MultiplyBlock"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.client.grpc.MatrixRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.client.grpc.MatrixResponse.getDefaultInstance()))
  ...
  public static abstract class BlockMultServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void addBlock(com.client.grpc.MatrixRequest request,
        io.grpc.stub.StreamObserver<com.client.grpc.MatrixResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_ADD_BLOCK, responseObserver);
    }

    /**
     */
    public void multiplyBlock(com.client.grpc.MatrixRequest request,
        io.grpc.stub.StreamObserver<com.client.grpc.MatrixResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.client.grpc.MatrixRequest,
                com.client.grpc.MatrixResponse>(
  ...
  public static final class BlockMultServiceBlockingStub extends io.grpc.stub.AbstractStub<BlockMultServiceBlockingStub> {
    ...
    /**
     */
    public com.client.grpc.MatrixResponse addBlock(com.client.grpc.MatrixRequest request) {
    ...
    /**
     */
    public com.client.grpc.MatrixResponse multiplyBlock(com.client.grpc.MatrixRequest request) {
      return blockingUnaryCall(
  ...
  public static final class BlockMultServiceFutureStub extends io.grpc.stub.AbstractStub<BlockMultServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.client.grpc.MatrixResponse> addBlock(
        com.client.grpc.MatrixRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.client.grpc.MatrixResponse> multiplyBlock(
        com.client.grpc.MatrixRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_BLOCK:
          serviceImpl.addBlock((com.client.grpc.MatrixRequest) request,
              (io.grpc.stub.StreamObserver<com.client.grpc.MatrixResponse>) responseObserver);
          break;
        case METHODID_MULTIPLY_BLOCK:
          serviceImpl.multiplyBlock((com.client.grpc.MatrixRequest) request,
              (io.grpc.stub.StreamObserver<com.client.grpc.MatrixResponse>) responseObserver);
          break;
        default:
  ...
  private static final class BlockMultServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.client.grpc.BlockMultServiceOuterClass.getDescriptor();
    }
  }
