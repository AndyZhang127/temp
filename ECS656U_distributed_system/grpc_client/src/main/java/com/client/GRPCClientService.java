...
import com.client.grpc.BlockMultServiceGrpc;
import com.client.grpc.BlockMultServiceGrpc.BlockMultServiceBlockingStub;
import com.client.grpc.MatrixRequest;
import com.client.grpc.MatrixResponse;
import com.client.MatrixUtils;
...
public class GRPCClientService {
	...
	//@Value("${com.client.grpc.client.stubPorts}")
	private int[] stubPorts = {8081,8082,8083,8084,8085,8086,8087,8088};

	@Value("${com.client.grpc.client.serverAddress}")
	...
	public String addMatrixFiles(String matrixStringA, String matrixStringB, long deadline) throws InvalidMatrixException, ExecutionException, InterruptedException {
		...
		return MatrixUtils.encodeMatrix(MatrixBlock);
	}
